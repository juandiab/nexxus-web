...
.page-hero-bg {
  ...
  background: radial-gradient(ellipse at 40% 60%, rgba(0,123,167,0.12) 0%, transparent 60%);
}
...
.social-btn:hover { background: rgba(0,123,167,0.15); border-color: var(--nt-primary); color: var(--nt-primary-l); }
